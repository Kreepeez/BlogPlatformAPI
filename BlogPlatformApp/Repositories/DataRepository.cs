...
namespace BlogPlatformApp.Repositories
{
    public class DataRepository<T> : IDataRepository<T> where T : class
    {
        ...
        public DataRepository(PostContext context)
        {
            _context = context;
        }
        ...
        {
            var post = await _context.BlogPosts.Include(x => x.BlogPostTags).ThenInclude(y => y.Tag).FirstOrDefaultAsync(x => x.Id == id);
